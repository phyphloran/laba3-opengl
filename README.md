...
- Отрисовка пирамиды и куба с разными OpenGL-материалами: пирамида использует изумруд, куб — золото.
- Настроенное освещение с двумя режимами: общий свет и прожекторный луч; источник света фиксирован относительно экрана и не вращается вместе со сценой.
...
- **ПКМ** — вращение куба вокруг выбранного ребра пирамиды.
- **↑ / ↓** — перемещение куба вдоль выбранного ребра.
- **Цифры `1..9` и `0`** — выбор ребра пирамиды (`0` = ребро №10).
- **W** — включить прожекторный режим освещения.
- **S** — включить общий режим освещения.
- **Зажать ЛКМ + движение** — вращение камеры вокруг сцены.
